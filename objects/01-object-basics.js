...
console.log(`The value of cordless->oldDrill ${oldDrill["cordless"]}`);

// TRY IT! Use dot notation to print the voltage of newDrill's battery.
console.log(`The value of battery->newDrill ${oldDrill.battery}`);
...
city.ClaimToFame = "Gateway of Arch";
console.log(city);