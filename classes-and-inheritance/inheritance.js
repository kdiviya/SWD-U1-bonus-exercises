...
class Milk extends Beverage{
    ...
    describe(){
        let value;
        if(this.source === "almond" || this.source === "soy"){
            this.isNonDairy = true;
            this.flavoring = "unsweetened";
             value = "Non Dairy";
             console.log(`The ${this.ounces}-oz ${this.name} is ${value} and is extracted from the ${this.source} and it is ${this.flavoring} flavor. It is available in ${this.container}`);
        }
        else{
            this.isNonDairy = false;
             value = "Dairy";
             console.log(`The ${this.ounces}-oz ${this.name} is ${value} and is extracted from the ${this.source}. It is available in ${this.container}.`);
        }
        
    }
}

let regularMilk = new Milk("Regular Milk", 10, "cartoon", "cow");
let almondMilk = new Milk("Almond Milk", 12, "bottle", "almond");
let soyMilk = new Milk("Soy Milk", 8, "bottle", "soy");
let chocMilk  = new Milk("Chocolate Milk", 6, "cartoon", "cow")


console.log(regularMilk);
